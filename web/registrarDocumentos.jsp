...
<html>
    ...
    <body>
        ...
        <form method="post" action="Documentos">
            ...
            <input type="text" name="docNombre" required maxlength=30 placeholder="Ingrese el nombre del documento" pattern="^[A-Za-z]{6,30}$" title="Debe la descipcion del documento" required >
