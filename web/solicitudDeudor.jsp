...
<html>
    ...
    <body>
        ...
        <form method="post" action="Solicitud">
            ...
            <input type="text" name="solMonto" placeholder="Digite el monto del prestamo" title="Debe ingresar un monto adecuado"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1')">
            <label for="usuCuotas">Cuotas:</label>
            <input type="number" name="solCuotas" required placeholder="Ingrese la cantidad de cuotas" title="Debe ingresar una cantidad valida" required oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1')"> 
